...
This folder defines all source code for the 'stock-market-etl' pipeline:
...
* Take a look at the sample under "sample_users_stock_market_etl.py" to get familiar with the syntax.
